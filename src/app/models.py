...
class NRPZS(db.Model):
    ...
    poskytovatel_telefon = db.Column(db.String(100))
    poskytovatel_fax = db.Column(db.String(100))
    poskytovatel_email = db.Column(db.String(100))
    poskytovatel_web = db.Column(db.String(100))
